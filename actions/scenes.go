...
func (v ScenesResource) List(c buffalo.Context) error {
	...
	return c.Render(200, r.Auto(c, scenes))
}
...
func (v ScenesResource) Show(c buffalo.Context) error {
	...
	return c.Render(200, r.Auto(c, scene))
}
...
func (v ScenesResource) New(c buffalo.Context) error {
	return c.Render(200, r.Auto(c, &models.Scene{}))
}
...
func (v ScenesResource) Create(c buffalo.Context) error {
	...
	if verrs.HasAny() {
		...
		// correct the input.
		return c.Render(422, r.Auto(c, scene))
	}
	...
	return c.Render(201, r.Auto(c, scene))
}
